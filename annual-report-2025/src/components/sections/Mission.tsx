          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto">
                We oversee breaking changes in the language, protect the Kotlin trademark, promote creation of Kotlin Multiplatform libraries, and increase the adoption of Kotlin in education.
              </p>
            </div>
          </div>
        </AnimatedSection>
