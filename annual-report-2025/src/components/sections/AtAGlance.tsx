...
}: {children: React.ReactNode;variant?: "purple" | "neutral" | "gold" | "silver";}) => {
  const variants = {
...
}: {label: string;value?: string | number;descriptor?: string;secondary?: string;children?: React.ReactNode;href?: string;}) => {
  const cardContent =
...
{ label: "Active Developers", value: "2.7M+", isText: true },
{ label: "GitHub Repositories", value: "2M+", isText: true },
{ label: "Universities Teaching Kotlin", value: "500+", isText: true },
{ label: "KMP Libraries on Maven", value: "3,000+", isText: true }];
        ...
        <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <AnimatedCard delay={0.35}>
                  <MetricCard
                    ...
                    value={2}
                    secondary="Kotlin 2.2, Kotlin 2.3" />

                </AnimatedCard>

                {/* Collaboration */}
                <AnimatedCard delay={0.4}>
                  <MetricCard label="Collaboration" href="#collaboration">
                    <p className="text-sm font-semibold text-white">
                      JetBrains × Gradle × Google 
                    </p>
          ...
          <AnimatedSection delay={0.2}>
            <div className="relative bg-white rounded-2xl p-6 md:p-8 h-full border border-border overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-lg font-medium text-muted-foreground mb-6">Kotlin Ecosystem Highlights</h3>
