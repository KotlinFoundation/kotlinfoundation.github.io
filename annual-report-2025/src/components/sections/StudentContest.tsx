...
const winners2025 = [
  ...
  },
  {
    ...
    quote:
      "PayFlo started as a simple idea, but the contest motivated me to polish every detail. Presenting at KotlinConf was a dream come true.",
    fullQuote: null as string | null,
  },
  {
      ...
      <div className="container-kotlin">
        ...
        <AnimatedSection delay={0.2}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <DraftBadge 
              variant="inline" 
              tooltip="Placeholder quotes — get real testimonials from Ksenia" 
            />
          </div>
          <p className="text-sm text-muted-foreground mb-4">
            Each winner receives a trip to KotlinConf 2025 in Copenhagen — tickets, travel, accommodation, and Kotlin swag.
          </p>
        </AnimatedSection>
