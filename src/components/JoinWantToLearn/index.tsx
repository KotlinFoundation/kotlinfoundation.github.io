      ...
      <section className={cn('ktl-layout ktl-layout--center', styles.sildes)}>
        ...
        <div className={styles.wrap}>
          ...
          <p className={cn(textCn('ktl-text-2'), styles.text)}>
            See our presentation with the latest information <br className={styles.br} />
            and insights about the Kotlin Foundation.
          </p>
          <Button mode="outline" size="l" href="/kotlin-foundation-presentation.pdf" target="_blank">
            View presentation
          </Button>
        </div>
      </section>
