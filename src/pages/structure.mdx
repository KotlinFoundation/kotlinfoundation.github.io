...
<Department
    ...
    members={[
        ...
        { name: 'Eve Matthaey', company: 'Meta' },
    ]}
>
...
<Department
    ...
    members={[
        ...
        { name: 'Jiri Ales', company: 'JetBrains' },
        { name: 'Jakub Vojtovic', company: 'JetBrains' },
    ]}
>
...
<Department
    ...
    members={[
        ...
        { name: 'Werner Dietl', company: 'Independent Director' },
        { name: 'Peng Jiang', company: 'Meta' },
        { name: 'Alexey Soshin', company: 'Meta' },
    ]}
>
...
<Department
    ...
    members={[
        { name: 'Ekaterina Petrova', company: 'JetBrains' },
...
<Department
    ...
    members={[
        { name: 'Jeffrey van Gogh', company: 'Google' },
        { name: 'Patrick Chenglo', company: 'Meta' },
        { name: 'Evgenii Pavelev', company: 'JetBrains' },
        { name: 'Justin Mancinelli', company: 'Touchlab' },
        { name: 'Bigyan Rajbhandari', company: 'Google' },
    ]}
>
