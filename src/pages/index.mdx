...
import gradleLogo from "../images/partners/gradle-logo.png";
...
<GrantsBanner text="Apply for the 2026 Kotlin Foundation Grant Program for Library Authors" until={GRANT_PROGRAM_DEADLINE} />
