    ...
    [
      {
        ...
        companies: [
          ...
          { name: 'Google', image: googleLogo, url: '' },
        ]
      },
      {
        ...
        companies: [
          ...
          { name: 'Shopify', image: shopifyLogo, url: 'https://www.shopify.com/' },
...
<ProductHighlight title="Kotlin Now">
  <ProductHighlightItem value="570k">Active developers use Kotlin every month.</ProductHighlightItem>
