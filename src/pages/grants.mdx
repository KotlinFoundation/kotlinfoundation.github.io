...
<GrantsAction theme="dark"
  action="Application form" url="https://forms.gle/My2D81t9xEajURWu6"
>
To submit your project, fill in the application form.<br className="hide--mm"/> The first round of submissions closes May 15.
</GrantsAction>

<GrantsAction action="Terms & conditions" url="">
To be eligible, the project must comply with the<br className="hide--mm"/> requirements described in terms and conditions.
</GrantsAction>

If you have any questions, feel free to ask them in [#kotlin-foundation](https://slack-chats.kotlinlang.org/c/kotlin-foundation) channel in the Kotlinlang Slack or email them to [hello@kotlinfoundation.org](mailto:hello@kotlinfoundation.org).
