...
<GrantsAction theme="dark" action="Application form" url="https://forms.gle/cr8dJRwgEAqUWReg7">
...
To be eligible, the project must comply with the<br className="hide--mm"/> requirements described in terms and conditions.<br/><br/>You don't have to fill out this document; use it for reference purposes only.
</GrantsAction>
